function [x, cost, info, options, best_x] = isrncr_tCG(problem, x, options, sigma)
...
while true
    ...
    [eta, Heta, numit, stop_inner] = conjugte_solver(problem, x, fgradx, norm_grad, sigma, samp_hess_idx, samp_hess_p, options, storedb, key);
