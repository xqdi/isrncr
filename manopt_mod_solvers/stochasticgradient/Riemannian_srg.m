function [x, cost, info, options, best_x] = Riemannian_srg(problem, x, options)
...
%                   Hiroyuki Sato <hsato@amp.i.kyoto-u.ac.jp>, Feb., 2018.
    ...
    for epoch = 1 : options.maxepoch
        ...
        for inneriter = 1 : totalbatches
            ...
            % Update oracle calls
            oraclecalls = oraclecalls + 2*batchsize;  % for partialgrad at x.  
            ...
            % update Oracle calls 
            oraclecalls = oraclecalls + 1;          % for vector transport
